...
<<<<<<< HEAD
                        ...
                        <View style = {{width : '100%', height : 52, marginTop : 16}}>
                            <TextInput style = {{width : '100%', height : '100%', backgroundColor : '#fff', borderRadius : 12, paddingLeft : 20, fontSize : 14, fontFamily : 'KHNPHUotfR',}} placeholder="이메일 주소를 입력해주세요." autoCapitalize = "none" onChangeText = {(value) => this.setState({email : value})}></TextInput>
                        </View>
                        ...
                        <View style = {{width : '100%', height : 180, marginTop : 16, padding: 16, backgroundColor : '#fff', borderRadius : 12,}}>
                            <TextInput style = {{flex : 1, fontSize : 14, fontFamily : 'KHNPHUotfR', textAlignVertical : 'top'}} placeholder="내용을 입력해주세요." autoCapitalize = "none" multiline = {true} onChangeText = {(value) => this.setState({contents : value})} maxLength={2000}></TextInput>
